...
;;; operations such as `sine` and `cosine` that are generic over ordinary
;;; numbers and rational numbers.

;; Although the constructors do not check the type of arguments, the existed
;; procedures can't handle our types. So we have to extend these base
;; procedures.
