...
;;; each node encountered. To answer this question in general is
;;; difficult. Consider the special case where the relative frequencies of the
;;; `n` symbols are as described in exercise 2.71, and give the order of growth
;;; (as a function of `n`) of the number of steps needed to encode the most
