...
;;; structure is the number in the `car` plus the number in the `cdr` plus one
...
;;; box-and-pointer diagrams representing list structures mad up of exactly
...
;;;            ((c nil)
;;;             (c nil)))
;;; Never return at all: (a (b (c (a (b (c ...))))))
